...
Projects
=====
### 1. [Respiratory Pattern Monitoring with RF Near-Field Coherent Sensing (NCS) Cornell University](https://psharma15.github.io/RF-Vital-Sensing/)
...
### 2. Indoor Imaging from RFID Tag Backscatter for Real-Time People Tracking Cornell University
...
### 3. Accuracy and Resources Trade-off in Machine Learning Algorithms Cornell University
...
### 4. Online Trainable Near-Field Communication (NFC) Reader Maxim Integrated
...
### 5. Low-Voltage Arc Detection and Sensor Placement IIT Kharagpur
